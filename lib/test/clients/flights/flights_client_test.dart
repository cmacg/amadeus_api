...
import '../../../src/clients/flights/amadeus_flights_client.dart';
import '../../../src/models/flights/locations/v1/location.dart';
import '../../../src/models/flights/offers/v2/flight_offer.dart';
import '../../../src/models/flights/offers/v2/itineraries.dart';
import '../../../src/models/flights/offers/v2/segment.dart';
import '../../../src/models/flights/status/v2/flight_status.dart';
...
void main() async {
  ...
  test('testing flight offers search', () async {
    ...
    List<FlightOffer> flightOffers = await flightsClient.searchFlightOffers(
        ...
        departureDate: DateFormat('yyyy-MM-dd').format(depart));
